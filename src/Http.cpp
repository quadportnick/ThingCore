...
void ThingCore::_setupHttp() {
  ...
  _httpServer.on("/settings", HTTPMethod::HTTP_OPTIONS, [&]() {
    _httpServer.sendHeader("Access-Control-Allow-Origin","null");
    _httpServer.sendHeader("Access-Control-Allow-Credentials","true");
